...
The most recent release is ihop 2.4.0, released October 24, 2019.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:ihop:2.4.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "ihop", version = "2.4.0")
```
