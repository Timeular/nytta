...
The most recent release is ihop 5.2.0, released February 07, 2022.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:ihop:5.2.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "ihop", version = "5.2.0")
```
