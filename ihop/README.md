...
The most recent release is ihop 5.3.0, released February 10, 2022.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:ihop:5.3.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "ihop", version = "5.3.0")
```
