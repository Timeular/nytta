...
The most recent release is ihop 5.5.0, released October 18, 2023.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:ihop:5.5.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "ihop", version = "5.5.0")
```
