...
The most recent release is spring-ext 2.4.0, released October 24, 2019.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:spring-ext:2.4.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "spring-ext", version = "2.4.0")
```
