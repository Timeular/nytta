...
The most recent release is spring-ext 2.1.0, released February 20, 2019.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:spring-ext:2.1.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "spring-ext", version = "2.1.0")
```
