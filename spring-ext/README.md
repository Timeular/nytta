...
The most recent release is spring-ext 5.4.0, released November 16, 2022.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:spring-ext:5.4.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "spring-ext", version = "5.4.0")
```
