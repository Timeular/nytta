...
The most recent release is spring-ext 5.3.0, released February 10, 2022.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:spring-ext:5.3.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "spring-ext", version = "5.3.0")
```
