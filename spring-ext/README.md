...
The most recent release is spring-ext 2.2.0, released March 14, 2019.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:spring-ext:2.2.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "spring-ext", version = "2.2.0")
```
