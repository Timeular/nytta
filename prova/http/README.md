...
The most recent release is prova-http 3.0.0, released December 10, 2019.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta.prova:http:3.0.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta.prova", name = "http", version = "3.0.0")
```
