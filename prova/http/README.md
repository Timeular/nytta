...
The most recent release is prova-http 5.2.0, released February 07, 2022.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta.prova:http:5.2.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta.prova", name = "http", version = "5.2.0")
```
