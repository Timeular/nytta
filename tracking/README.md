...
The most recent release is tracking 5.2.0, released February 07, 2022.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:tracking:5.2.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "tracking", version = "5.2.0")
```
