...
The most recent release is tracking 5.1.0, released December 03, 2021.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:tracking:5.1.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "tracking", version = "5.1.0")
```
