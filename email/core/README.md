...
The most recent release is email-core 5.3.1, released May 24, 2022.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta.email:core:5.3.1'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta.email", name = "core", version = "5.3.1")
```
