...
The most recent release is email-core 2.3.1, released September 30, 2019.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta.email:core:2.3.1'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta.email", name = "core", version = "2.3.1")
```
