...
The most recent release is email-core 3.1.0, released May 28, 2020.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta.email:core:3.1.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta.email", name = "core", version = "3.1.0")
```
