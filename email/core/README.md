...
The most recent release is email-core 3.0.0, released December 10, 2019.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta.email:core:3.0.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta.email", name = "core", version = "3.0.0")
```
