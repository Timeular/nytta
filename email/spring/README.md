...
The most recent release is spring-email 5.3.1, released May 24, 2022.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta.email:spring:5.3.1'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta.email", name = "spring", version = "5.3.1")
```
