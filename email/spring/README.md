...
The most recent release is spring-email 5.4.0, released November 16, 2022.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta.email:spring:5.4.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta.email", name = "spring", version = "5.4.0")
```
