...
The most recent release is spring-email 5.5.0, released October 18, 2023.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta.email:spring:5.5.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta.email", name = "spring", version = "5.5.0")
```
