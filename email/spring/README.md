...
The most recent release is spring-email 5.0.0, released December 03, 2021.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta.email:spring:5.0.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta.email", name = "spring", version = "5.0.0")
```
