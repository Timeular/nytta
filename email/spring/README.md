...
The most recent release is spring-email 2.3.1, released September 30, 2019.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta.email:spring:2.3.1'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta.email", name = "spring", version = "2.3.1")
```
