...
The most recent release is http-client 5.3.0, released February 10, 2022.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:http-client:5.3.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "http-client", version = "5.3.0")
```
