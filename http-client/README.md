...
The most recent release is http-client 5.3.1, released May 24, 2022.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:http-client:5.3.1'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "http-client", version = "5.3.1")
```
