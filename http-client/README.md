...
The most recent release is http-client 2.2.1, released March 18, 2019.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:http-client:2.2.1'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "http-client", version = "2.2.1")
```
