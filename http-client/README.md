...
The most recent release is http-client 5.4.0, released November 16, 2022.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:http-client:5.4.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "http-client", version = "5.4.0")
```
