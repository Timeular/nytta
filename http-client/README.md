...
The most recent release is http-client 5.5.0, released October 18, 2023.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:http-client:5.5.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "http-client", version = "5.5.0")
```
