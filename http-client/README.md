...
The most recent release is http-client 2.3.0, released September 24, 2019.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:http-client:2.3.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "http-client", version = "2.3.0")
```
