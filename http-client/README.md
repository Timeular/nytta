...
The most recent release is http-client 5.2.0, released February 07, 2022.
...
```gradle
// Gradle Groovy DSL
compile 'com.timeular.nytta:http-client:5.2.0'

// Gradle Kotlin DSL
compile(group = "com.timeular.nytta", name = "http-client", version = "5.2.0")
```
